...
from ..transformers_offline.cache_utils import Cache, DynamicCache, SlidingWindowCache, StaticCache
from ..transformers_offline.generation import GenerationMixin
from ..transformers_offline.modeling_attn_mask_utils import AttentionMaskConverter
from ..transformers_offline.modeling_outputs import BaseModelOutputWithPast, ModelOutput
from ..transformers_offline.modeling_rope_utils import ROPE_INIT_FUNCTIONS
from ..transformers_offline.modeling_utils import PreTrainedModel
...
if is_flash_attn_2_available():
    from ..transformers_offline.modeling_flash_attention_utils import _flash_attention_forward
else:
    flash_attn_varlen_func = None
